...
function Hero({ data }) {
    return (
        <section className='w-full relative overflow-hidden'>
            <div className='absolute z-[-1] w-full h-[330px] sm:h-[340px] md:h-[572px] rounded-bl-[50px] sm:rounded-bl-[90px] md:rounded-bl-[300px] bg-gradient-to-r from-gr-a-1 to-gr-a-2'>
            </div>
            <Core.Container>
                <div className="flex justify-between items-start h-[350px] sm:h-[390px] md:h-[620px] 2xl:h-[720px] pt-[30px] sm:pt-[40px] xl:pt-[80px] 2xl:pt-[130px]">
                    <div>
