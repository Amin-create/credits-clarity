...
function Cta() {
    return (
        <section className='cta-section w-full bg-[#f8ffff7a]'>           
                <Core.Container>
                <div className="flex flex-col justify-start items-start gap-y-12 py-[90px]">
                    <h1 className="max-w-[450px] text-[#fff] text-[48px] leading-[56px] font-bold">
                        Discover Credit Clarity  - Your New Favorite
                    </h1>
                    <button type="button" className="w-[311px] flex justify-between items-center  text-[#fff] text-[25px] font-bold whitespace-nowrap rounded-full bg-[#09EC92] pl-8 pr-1 py-1">
                        Sign up free
