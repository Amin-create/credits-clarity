            ...
            <div className={"flex justify-between pt-12 pb-3"}>
                {isEvenIndex === true ?
                    <>
                        ...
                        <div className='flex justify-start items-center w-[60%] pr-24'>
                            <div>
                                <h4 className="text-dark-blue text-[22px] leading-[70px] tracking-[-1px] font-bold">{value?.heading}</h4>
                                {value?.texts.map((value) => <p className="text-dark-blue text-[18px] leading-[30px] font-regular mb-4">{value}</p>)}
                            </div>
                        </div>
                    </>
                    :
